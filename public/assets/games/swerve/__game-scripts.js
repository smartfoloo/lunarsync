...
Environment.prototype.initialize = function() {
    ...
    var a = this.props[r];
    if (a)
        for (var l = 0; l < a.length; l++) a[l].enabled && this.isPositionOnRoad(a[l].getLocalPosition()) && (FAST_HIDE ? a[l].model.model.meshInstances[0]._hidden = !0 : a[l].enabled = !1)
    ...
    if (e.model)
        for (var i = e.model.model.meshInstances, n = 0; n < i.length; n++) i[n].setParameter("material_diffuse", t)
    ...
    for (var t = this.player.getLocalPosition(), i = Math.floor((t.x + this._cellSize / 4) / this._cellSize), n = Math.ceil((t.z - this._cellSize / 4) / this._cellSize), r = i - this.xLead; r < i + this.xLead; r++)
        for (var o = n + this.zLead; o > n - this.zLead; o--) this.fillCell(i, n, r, o, e);
    this.fillFromQueue()
};
...
Vehicle.attributes.add("trails", {
    ...
    if (this.trails) {
        ...
        if (4 === e.length && this.current.trails && 4 === this.current.trails.length)
            for (var t = 0; 4 > t; t++) e[t].script.trail.__attributes.pivot = this.current.trails[t]
    }
...
Score.attributes.add("levelDistance", {
    ...
    if (this.app.ui.checkpoints && this.level > 1)
        for (var e = this.app.ui.checkpoints.children, t = 1; t < Math.min(this.level, e.length); t++) e[t].classList.remove("active");
    ...
    if (this.app.ui.score && (this.app.ui.score.textContent = this.score.toLocaleString()), this.app.ui.checkpoints && this.level > 1)
        for (var e = this.app.ui.checkpoints.children, t = 1; t < Math.min(this.level, e.length); t++) e[t].classList.add("active")
...
Level.attributes.add("roadStraight", {
    ...
    if (r) {
        if (i.copy(this.blocks[t].getLocalPosition()), r === BLOCK_STRAIGHT_LEFT || r === BLOCK_CORNER_LEFT)
            if (i.z -= BLOCK_SIZE, this.forceStraight) n = BLOCK_STRAIGHT_LEFT;
            else {
            ...
            } else if (r === BLOCK_STRAIGHT_RIGHT || r === BLOCK_CORNER_RIGHT)
            if (i.x += BLOCK_SIZE, this.forceStraight) n = BLOCK_STRAIGHT_RIGHT;
            else {
                for (var o = !0, s = !1, a = 1; 4 >= a; a++) {
                    var l = t - a,
                        h = this.getBlockType(l);
...
Fps.prototype.initialize = function() {
            ...
            7: [
                function(e, t) {
                    ...
                    t.exports = function(t, r) {
                        ...
                        function l(e) {
                            for (var t, i = p.getElementsByTagName("style"), n = 0; i.length > n; n++)
                                if (t = i[n], t.type.match(b)) {
                                    var o = s(r);
                                    o.modifyVars = e;
                                    var l = t.innerHTML || "";
            ...
            10: [
                function(e, t) {
                    ...
                    var n = function(e, t, i) {
                            if (e)
                                for (var n = 0; i.length > n; n++) e.hasOwnProperty(i[n]) && (t[i[n]] = e[i[n]])
                        },
                ...
                function(e, t) {
                    t.exports = {
                        ...
                        removeListener: function(e) {
                            for (var t = 0; this._listeners.length > t; t++)
                ...
                function(e, t) {
                    ...
                    t.exports = function(e) {
                        ...
                        return t.prototype.toCSS = function(t) {
                            ...
                            if (t.pluginManager)
                                for (var u = t.pluginManager.getPostProcessors(), p = 0; u.length > p; p++) a.css = u[p].process(a.css, {
                                    sourceMap: s,
                                    options: t,
                ...
                function(e, t) {
                    t.exports = function(e, t) {
                        ...
                        var n, r, o, s, a, l, h, c, u, p = e.length,
                            ...
                            v = 0;
                        for (a = 0; p > a; a++)
                            if (h = e.charCodeAt(a), !(h >= 97 && 122 >= h || 34 > h)) switch (h) {
                                case 40:
                                    d++, r = a;
                                    continue;
                                case 41:
                                ...
                                case 39:
                                case 96:
                                    for (u = 0, l = a, a += 1; p > a; a++)
                                        if (c = e.charCodeAt(a), !(c > 96)) {
                                            if (c == h) {
                                                u = 1;
                                                break
                                            }
                                ...
                                case 47:
                                    if (d || a == p - 1) continue;
                                    if (c = e.charCodeAt(a + 1), 47 == c)
                                        for (a += 2; p > a && (c = e.charCodeAt(a), !(13 >= c) || 10 != c && 13 != c); a++);
                                    else if (42 == c) {
                    ...
                    t.exports = function() {
                        ...
                        h.save = function() {
                            ...
                            for (var i = t.length, n = 0; i > n; n++)
                                if (e.charAt(h.i + n) !== t.charAt(n)) return null;
                            return y(i), t
                        }, h.$quoted = function() {
                            var t = e.charAt(h.i);
                            if ("'" === t || '"' === t) {
                        ...
                        return h.peek = function(t) {
                            if ("string" == typeof t) {
                                for (var i = 0; t.length > i; i++)
                                    if (e.charAt(h.i + i) !== t.charAt(i)) return !1;
                                return !0
                            }
                            return t.test(s)
                        ...
                        a = function l(e, t, a) {
                            ...
                            return {
                                parse: function(o, s, h) {
                                    var c, u, p, f, m = null,
                                        v = "";
                                    if (u = h && h.globalVars ? l.serializeVars(h.globalVars) + "\n" : "", p = h && h.modifyVars ? "\n" + l.serializeVars(h.modifyVars) : "", e.pluginManager)
                                        for (var g = e.pluginManager.getPreProcessors(), y = 0; g.length > y; y++) o = g[y].process(o, {
                                            context: e,
                                            imports: t,
                                            fileInfo: a
                                        });
                                ...
                                parsers: f = {
                                    ...
                                    mixin: {
                                        ...
                                        args: function(e) {
                                            ...
                                            for (d.save();;) {
                                                ...
                                                var g = null;
                                                if (e ? a.value && 1 == a.value.length && (g = a.value[0]) : g = a, g && g instanceof n.Variable)
                                                    if (d.$char(":")) {
                                        ...
                                        definition: function() {
                                            var e, t, i, r, o = [],
                                                s = !1;
                                            if (!("." !== d.currentChar() && "#" !== d.currentChar() || d.peek(/^[^{]*\}/)))
                                                if (d.save(), t = d.$re(/^([#.](?:[\w-]|\\(?:[A-Fa-f0-9]{1,6} ?|[^A-Fa-f0-9]))+)\s*\(/)) {
                                                    e = t[1];
                                                    var a = this.args(!1);
                                    ...
                                    rule: function(t) {
                                        var i, r, o, s, l, h = d.i,
                                            c = d.currentChar();
                                        if ("." !== c && "#" !== c && "&" !== c && ":" !== c)
                                            if (d.save(), i = this.variable() || this.ruleProperty()) {
                                    ...
                                    mediaFeature: function() {
                                        ...
                                        d.save();
                                        do
                                            if (e = i.keyword() || i.variable()) r.push(e);
                                            else if (d.$char("(")) {
                                    ...
                                    mediaFeatures: function() {
                                        ...
                                        do
                                            ...
                                            } else if (e = t.variable(), e && (i.push(e), !d.$char(","))) break; while (e);
                                    ...
                                    value: function() {
                                        var e, t = [];
                                        do
                                            if (e = this.expression(), e && (t.push(e), !d.$char(","))) break;
                                        while (e);
                                    ...
                                    expression: function() {
                                        var e, t, i = [];
                                        do e = this.comment(), e ? i.push(e) : (e = this.addition() || this.entity(), e && (i.push(e), d.peek(/^\/[\/*]/) || (t = d.$char("/"), t && i.push(new n.Anonymous(t))))); while (e);
            ...
            38: [
                function(e, t) {
                    ...
                    i.prototype.addPlugins = function(e) {
                        if (e)
                            for (var t = 0; e.length > t; t++) this.addPlugin(e[t])
                    ...
                    t.exports = function(e) {
                        ...
                        return t.prototype.normalizeFilename = function(e) {
                            ...
                            if (e) {
                                ...
                                if (r = e.split("\n"), s = r[r.length - 1], t)
                                    if (n)
                                        for (l = 0; r.length > l; l++) this._sourceMapGenerator.addMapping({
                                            generated: {
                ...
                function(e, t) {
                    var i = e("./node"),
                        ...
                        o = function(e, t, i, r, o, s, a, l) {
                            var h;
                            if (this.name = e, this.value = t, i)
                                for (Array.isArray(i) ? this.rules = i : (this.rules = [i], this.rules[0].selectors = new n([], null, null, this.index, o).createEmptySelectors()), h = 0; this.rules.length > h; h++) this.rules[h].allowImports = !0;
                    ...
                    o.prototype = new i, o.prototype.type = "Directive", o.prototype.accept = function(e) {
                        ...
                        if (this.isReferenced = !0, this.rules)
                            for (t = this.rules, e = 0; t.length > e; e++) t[e].markReferenced && t[e].markReferenced()
            ...
            65: [
                function(e, t) {
                    ...
                    l.prototype = new a, l.prototype.type = "Media", l.prototype.isRulesetLike = !0, l.prototype.accept = function(e) {
                        ...
                        for (var t = [], i = this.permute(e.slice(1)), n = 0; i.length > n; n++)
                            for (var r = 0; e[0].length > r; r++) t.push([e[0][r]].concat(i[n]));
                        return t
                ...
                function(e, t) {
                    ...
                    s.prototype = new i, s.prototype.type = "MixinCall", s.prototype.accept = function(e) {
                        ...
                        var i, n, s, a, l, h, c, u, p, f, d, m, v, g, y, b, w = [],
                            ...
                            R = 1,
                            P = 2;
                        for (c = 0; this.arguments.length > c; c++)
                            if (a = this.arguments[c], l = a.value.eval(e), a.expand && Array.isArray(l.value))
                                for (l = l.value, u = 0; l.length > u; u++) w.push({
                                    value: l[u]
                                });
                            else w.push({
                                name: a.name,
                        ...
                        }, c = 0; e.frames.length > c; c++)
                            if ((i = e.frames[c].find(this.selector, null, b)).length > 0) {
                                for (d = !0, u = 0; i.length > u; u++) {
                                    for (n = i[u].rule, s = i[u].path, f = !1, p = 0; e.frames.length > p; p++)
                                        if (!(n instanceof r) && n === (e.frames[p].originalRuleset || e.frames[p])) {
                                            f = !0;
                                            break
                                        }
                                    f || n.matchArgs(w, e) && (m = {
                                ...
                                for (u = 0; C.length > u; u++)
                                    if (m = C[u].group, m === _ || m === v) try {
                                    ...
                                    if (S) {
                                        if (!this.currentFileInfo || !this.currentFileInfo.reference)
                                            for (c = 0; x.length > c; c++) h = x[c], h.markReferenced && h.markReferenced();
                                        return x
                                    }
                            }
                        throw d ? {
                ...
                function(e, t) {
                    ...
                    l.prototype = new r, l.prototype.type = "MixinDefinition", l.prototype.evalFirst = !0, l.prototype.accept = function(e) {
                        ...
                        var l, h, c, u, p, f, d, m, v = new r(null, null),
                            ...
                            y = 0;
                        if (t.frames && t.frames[0] && t.frames[0].functionRegistry && (v.functionRegistry = t.frames[0].functionRegistry.inherit()), t = new a.Eval(t, [v].concat(t.frames)), i)
                            for (i = i.slice(0), y = i.length, c = 0; y > c; c++)
                                if (h = i[c], f = h && h.name) {
                                    for (d = !1, u = 0; g.length > u; u++)
                                        if (!n[u] && f === g[u].name) {
                        ...
                        for (m = 0, c = 0; g.length > c; c++)
                            if (!n[c]) {
                                if (h = i && i[m], f = g[c].name)
                                    if (g[c].variadic) {
                                ...
                                if (g[c].variadic && i)
                                    for (u = m; y > u; u++) n[u] = i[u].value.eval(e);
                                m++
                            }
                        return v
            ...
            72: [
                function(e, t) {
                    ...
                    o.prototype = new n, o.prototype.type = "Quoted", o.prototype.genCSS = function(e, t) {
                        ...
                        function t(e, t, i) {
                            var n = e;
                            do e = n, n = e.replace(t, i); while (e !== n);
                            return n
                        }
                        var i = this,
                            n = this.value,
            ...
            75: [
                function(e, t) {
                    ...
                    u.prototype = new i, u.prototype.type = "Ruleset", u.prototype.isRuleset = !0, u.prototype.isRulesetLike = !0, u.prototype.accept = function(e) {
                        ...
                        for (o = 0; g.length > o; o++)
                            if (c = g[o], c instanceof u && c.selectors && 1 === c.selectors.length && c.selectors[0].isJustParentSelector()) {
                                g.splice(o--, 1);
                                for (var w = 0; c.rules.length > w; w++) p = c.rules[w], p instanceof n && p.variable || g.splice(++o, 0, p)
                            }
                        if (m.shift(), v.shift(), e.mediaBlocks)
                            for (o = b; e.mediaBlocks.length > o; o++) e.mediaBlocks[o].bubbleSelectors(t);
                        return d
                    }, u.prototype.evalImports = function(e) {
                        var t, i, n = this.rules;
                        if (n)
                            for (t = 0; n.length > t; t++) "Import" === n[t].type && (i = n[t].eval(e), i && i.length ? (n.splice.apply(n, [t, 1].concat(i)), t += i.length - 1) : n.splice(t, 1, i), this.resetCache())
                        ...
                        return a in this._lookups ? this._lookups[a] : (this.rulesets().forEach(function(a) {
                            if (a !== t)
                                for (var l = 0; a.selectors.length > l; l++)
                                    if (n = e.match(a.selectors[l])) {
                        ...
                        if (h = l.concat(h), !this.root) {
                            ...
                            for (u = e.compress ? "," : ",\n" + f, n = 0; y > n; n++)
                                if (a = g[n], v = a.length)
                                    for (n > 0 && t.add(u), e.firstSelector = !0, a[0].genCSS(e, t), e.firstSelector = !1, r = 1; v > r; r++) a[r].genCSS(e, t);
                            t.add((e.compress ? "{" : " {\n") + p)
                        }
                        ...
                        var e;
                        if (this.selectors)
                            for (e = 0; this.selectors.length > e; e++) this.selectors[e].markReferenced();
                        if (this.rules)
                            for (e = 0; this.rules.length > e; e++) this.rules[e].markReferenced && this.rules[e].markReferenced()
                    }, u.prototype.getIsReferenced = function() {
                        var e, t, i, n;
                        if (this.paths)
                            for (e = 0; this.paths.length > e; e++)
                                for (i = this.paths[e], t = 0; i.length > t; t++)
                                    if (i[t].getIsReferenced && i[t].getIsReferenced()) return !0;
                        if (this.selectors)
                            for (e = 0; this.selectors.length > e; e++)
                                if (n = this.selectors[e], n.getIsReferenced && n.getIsReferenced()) return !0;
                        return !1
                        ...
                        function l(e, t, i) {
                            ...
                            for (d = [], m = [
                                []
                            ], s = 0; i.elements.length > s; s++)
                                if (y = i.elements[s], "&" !== y.value) {
                                    var S = r(y);
                                    if (null != S) {
                                        u(d, m);
                                        var C, k = [],
                                    ...
                                    for (x = !0, v = [], u(d, m), p = 0; m.length > p; p++)
                                        if (g = m[p], 0 === t.length) g.length > 0 && g[0].elements.push(new o(y.combinator, "", y.index, y.currentFileInfo)), v.push(g);
                                        else
                        ...
                        if (f = [], d = l(f, t, i), !d)
                            if (t.length > 0)
                                for (f = [], p = 0; t.length > p; p++) f.push(t[p].concat(i));
                            else f = [
                                [i]
                            ];
            ...
            76: [
                function(e, t) {
                    ...
                    r.prototype = new i, r.prototype.type = "Selector", r.prototype.accept = function(e) {
                        ...
                        for (i = 0; t > i; i++)
                            if (n[i].value !== e._elements[i]) return 0;
                        return t
                        ...
                        var i, n;
                        if (e && e.firstSelector || "" !== this.elements[0].combinator.value || t.add(" ", this.currentFileInfo, this.index), !this._css)
                            for (i = 0; this.elements.length > i; i++) n = this.elements[i], n.genCSS(e, t)
                    }, r.prototype.markReferenced = function() {
                        this.isReferenced = !0
                    ...
                    r.prototype = new i, r.prototype.type = "Unit", r.prototype.clone = function() {
                        ...
                        for (e in i)
                            if (i.hasOwnProperty(e)) {
                                var n = i[e];
                                if (n > 0)
                                    for (t = 0; n > t; t++) this.numerator.push(e);
                                else if (0 > n)
                                    for (t = 0; - n > t; t++) this.denominator.push(e)
                            }
                ...
                function(e, t) {
                    ...
                    s.prototype = {
                        ...
                        doExtendChaining: function(e, t, n) {
                            var r, o, s, a, l, h, c, u, p = [],
                                f = this;
                            for (n = n || 0, r = 0; e.length > r; r++)
                                for (o = 0; t.length > o; o++) h = e[r], c = t[o], h.parent_ids.indexOf(c.object_id) >= 0 || (l = [c.selfSelectors[0]], s = f.findMatch(h, l), s.length && (h.hasFoundMatches = !0, h.selfSelectors.forEach(function(e) {
                        ...
                        visitRuleset: function(e) {
                            if (!e.root) {
                                ...
                                for (n = 0; o.length > n; n++)
                                    for (i = 0; e.paths.length > i; i++)
                                        if (r = e.paths[i], !e.extendOnEveryPath) {
                        ...
                        findMatch: function(e, t) {
                            ...
                            for (i = 0; t.length > i; i++)
                                for (n = t[i], r = 0; n.elements.length > r; r++)
                                    for (o = n.elements[r], (e.allowBefore || 0 === i && 0 === r) && u.push({
                                        pathIndex: i,
                                        index: r,
                                        matched: 0,
                    ...
                    o.prototype = {
                        ...
                        processImportNode: function(e, t, i) {
                            ...
                            if (!n || n.css && !r) this.importCount--, this.isFinished && this._sequencer.tryRun();
                                ...
                                for (var s = void 0 === n.css, a = 0; i.rules.length > a; a++)
                                    if (i.rules[a] === e) {
                                        i.rules[a] = n;
                                        break
                                    }
                    ...
                    r.prototype = {
                        ...
                        visitDirective: function(e, t) {
                            function n(e) {
                                ...
                                for (var n = 0; i.length > n; n++)
                                    if (t = i[n], t.getIsReferenced && t.getIsReferenced()) return !0;
                                return !1
                            }
                            if ("@charset" === e.name) {
                        ...
                        checkPropertiesInRoot: function(e) {
                            for (var t, n = 0; e.length > n; n++)
                                if (t = e[n], t instanceof i.Rule && !t.variable) throw {
                        ...
                        visitRuleset: function(e, t) {
                            ...
                            if (e.firstRoot && this.checkPropertiesInRoot(e.rules), e.root) e.accept(this._visitor), t.visitDeeper = !1, (e.firstRoot || e.rules && e.rules.length > 0) && r.splice(0, 0, e);
                                ...
                                e.paths && (e.paths = e.paths.filter(function(e) {
                                    var t;
                                    for (" " === e[0].elements[0].combinator.value && (e[0].elements[0].combinator = new i.Combinator("")), t = 0; e.length > t; t++)
                                        if (e[t].getIsReferenced() && e[t].getIsOutput()) return !0;
                                    return !1
                                }));
            ...
            89: [
                function(e, t) {
                    ...
                    function n(e, t) {
                        var i, r;
                        for (i in e)
                            if (e.hasOwnProperty(i)) switch (r = e[i], typeof r) {
                                case "function":
                    ...
                    a.prototype = {
                        ...
                        flatten: function(e, t) {
                            ...
                            for (n = 0, i = e.length; i > n; n++)
                                if (r = e[n], void 0 !== r)
                                    if (r.splice)
                                        for (s = 0, o = r.length; o > s; s++) a = r[s], void 0 !== a && (a.splice ? a.length && this.flatten(a, t) : t.push(a));
                                    else t.push(r);
                            return t
                        }
                    }, t.exports = a
    ...
    function(e, t) {
        ...
        function o() {
            var e, t = arguments;
            for (e in t[1])
                if (t[1].hasOwnProperty(e)) switch (n(t[1][e])) {
                    case "object":
                        t[0][e] = o({}, t[0][e], t[1][e]);
                        break;
                    case "array":
        ...
        function l(e, c) {
            ...
            function m() {
                ...
                if (d(), M.heat) {
                    if (z.length)
                        for (E = z.length; E--;) z[E].el.style[C[z[E].name].heatOn] = j ? f(C[z[E].name].heatmap, A.fps, 0, M.maxFps) : f(C[z[E].name].heatmap, A.duration, M.threshold, 0);
                    if (T.graph && C.column.heatOn)
                        for (E = O.length; E--;) O[E].style[C.column.heatOn] = j ? f(C.column.heatmap, G[E], 0, M.maxFps) : f(C.column.heatmap, $[E], M.threshold, 0)
                }
                if (T.graph)
                    for (F = 0; F < M.history; F++) O[F].style.height = (j ? G[F] ? Math.round(P / M.maxFps * Math.min(G[F], M.maxFps)) : 0 : $[F] ? Math.round(P / M.threshold * Math.min($[F], M.threshold)) : 0) + "px"
            }
