...
function uaGetDevice() {
    ...
    if (device == undefined) {
        ...
        // this workaround may not work properly forever and currently 'iPad OS' detection is broken in UAPArser.js - https://github.com/faisalman/ua-parser-js/issues/387
